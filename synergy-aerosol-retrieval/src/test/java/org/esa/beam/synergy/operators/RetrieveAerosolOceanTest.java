 ...
 */
public class RetrieveAerosolOceanTest
        extends TestCase {
     ...
     */
    public RetrieveAerosolOceanTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(RetrieveAerosolOceanTest.class);
    }
    ...
    public void testReadLutFromNetcdf() throws IOException {
        final URL url = RetrieveAerosolOceanTest.class.getResource("test_lut.nc");
        assertNotNull(url);
...
//       float COS_SUN(COS_SUN_dimension_1=13);
    ...
    public void testGetValueLUTEfficieny() {
        ...
        // todo: remember where this condition is defined?!
//        assertEquals(true, (t1 - t0 < 2000L));
    }
}