...
import org.esa.beam.synergy.operators.AotBoxcarInterpolationOp;
 ...
 */
public class AotBoxcarInterpolationAction extends AbstractVisatAction {

    @Override
    public void actionPerformed(CommandEvent event) {
        final DefaultSingleTargetProductDialog dialog =
                new DefaultSingleTargetProductDialog(OperatorSpi.getOperatorAlias(AotBoxcarInterpolationOp.class),
                        getAppContext(),
                        "Synergy Interpolation",
                        "synergyPerformBoxcarIntp");
