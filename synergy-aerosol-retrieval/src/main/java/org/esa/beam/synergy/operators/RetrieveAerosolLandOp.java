...
//    private String cloudyFlagExpression = fwdCloudFilter + "|| (cloud_flags_synergy.CLOUD || cloud_flags_synergy.CLOUD_FILLED || cloud_flags_synergy.SHADOW)";
    ...
    private final String flagCloudyName = SynergyConstants.flagCloudyName;
    private final String flagOceanName = SynergyConstants.flagOceanName;
    private final String flagSuccessName = SynergyConstants.flagSuccessName;
    private final String flagBorderName = SynergyConstants.flagBorderName;
    private final String flagFilledName = SynergyConstants.flagFilledName;
    private final String flagNegMetricName = SynergyConstants.flagNegMetricName;
    private final String flagAotLowName = SynergyConstants.flagAotLowName;
    private final String flagErrHighName = SynergyConstants.flagErrHighName;
    private final String flagCloudyDesc = SynergyConstants.flagCloudyDesc;
    private final String flagOceanDesc = SynergyConstants.flagOceanDesc;
    private final String flagSuccessDesc = SynergyConstants.flagSuccessDesc;
    private final String flagBorderDesc = SynergyConstants.flagBorderDesc;
    private final String flagFilledDesc = SynergyConstants.flagFilledDesc;
    private final String flagNegMetricDesc = SynergyConstants.flagNegMetricDesc;
    private final String flagAotLowDesc = SynergyConstants.flagAotLowDesc;
    private final String flagErrHighDesc = SynergyConstants.flagErrHighDesc;
    ...
    private final int filledMask = SynergyConstants.filledMask;
    ...
    public void initialize() throws OperatorException {
        ...
        //noDataVal = (float) SynergyPreprocessingConstants.OUTPUT_AOT_BAND_NODATAVALUE;
    ...
    private void readAerosolModelNumbers() {
        ...
        if (useCustomLandAerosol) {
            landAerosolModelString = customLandAerosol;
        } 
        landAerosolModelString.trim();
