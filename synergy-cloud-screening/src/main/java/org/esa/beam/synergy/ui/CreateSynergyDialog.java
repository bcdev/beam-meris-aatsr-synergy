...
/**
 * This is just a patch of DefaultSingleTargetProductDialog due to a bug in updateValueSets (2010/03/16).
 * If no custom dialog is needed, use DefaultSingleTargetProductDialog once bug is fixed.
 *
 * @author Olaf Danne
 * @version $Revision: $ $Date:  $
 */
public class CreateSynergyDialog extends SingleTargetProductDialog {
    ...
    public static SingleTargetProductDialog createDefaultDialog(String operatorName, AppContext appContext) {
        return new CreateSynergyDialog(operatorName, appContext, operatorName, null);
    }

    public CreateSynergyDialog(String operatorName, AppContext appContext, String title, String helpID) {
