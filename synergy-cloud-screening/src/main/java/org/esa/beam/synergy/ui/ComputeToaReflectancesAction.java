...
import org.esa.beam.synergy.operators.ComputeToaReflectancesOp;
import org.esa.beam.visat.VisatApp;
import org.esa.beam.visat.actions.AbstractVisatAction;

/**
 * Action for for computing TOA reflectances.
 *
 * @author Ralf Quast
...
public class ComputeToaReflectancesAction extends AbstractVisatAction {
    ...
    public void actionPerformed(CommandEvent commandEvent) {
        final DefaultSingleTargetProductDialog dialog =
                new DefaultSingleTargetProductDialog(OperatorSpi.getOperatorAlias(ComputeToaReflectancesOp.class),
                        getAppContext(),
                        "TOA Reflectance Computation",
                        "synergyReflectanceComputation");
