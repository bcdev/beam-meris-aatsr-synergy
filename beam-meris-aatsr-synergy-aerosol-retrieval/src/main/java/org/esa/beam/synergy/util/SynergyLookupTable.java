 ...
 */
public class SynergyLookupTable {
     ...
     */
    public SynergyLookupTable(final double[] values, final IntervalPartition... dimensions) {
     ...
     *                                  is {@code null} or any dimension is {@code null}.
     */
    public SynergyLookupTable(final float[] values, final IntervalPartition... dimensions) {
     ...
     *                                  is {@code null} or any dimension is {@code null}.
     */
    public SynergyLookupTable(final double[] values, final double[]... dimensions) {
     ...
     *                                  is {@code null} or any dimension is {@code null}.
     */
    public SynergyLookupTable(final float[] values, final float[]... dimensions) {
        this(values, IntervalPartition.createArray(dimensions));
    }

    private SynergyLookupTable(final Array values, final IntervalPartition... dimensions) {
